...
function MainContent() {
  return (
    <div className="main">
      ...
      <div className="info relative whitespace-normal mx-auto max-w-screen-xl px-4 py-52 sm:px-6 lg:flex lg:h-max lg:items-center lg:px-5">
        <div className="main-text whitespace-normal ltr:sm:text-left rtl:sm:text-right">
          ...
          <div className="mt-8 whitespace-normal flex flex-wrap gap-4 text-center">
            <a
              href="/Solution"
              className="block rounded bg-purple-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-purple-700 focus:outline-none focus:ring active:bg-purple-500 sm:w-auto"
            >
              Learn more
            </a>
            <a
              href="/contact"
              className="block rounded bg-white px-12 py-3 text-sm font-medium text-purple-600 shadow hover:blue-rose-700 focus:outline-none focus:ring active:text-blue-500 sm:w-auto"
            >
              Contact us
            </a>
          </div>
